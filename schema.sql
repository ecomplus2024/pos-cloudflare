...
INSERT INTO products (category_id, name, price, image_url, available, production_unit, is_topping) VALUES
  (1, 'Cà phê đen', 25000, 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&h=400&fit=crop&v=3', 1, 'counter', 0),
  (1, 'Cà phê sữa đá', 30000, 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400&h=400&fit=crop&v=3', 1, 'counter', 0),
  (1, 'Bạc xỉu', 35000, 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=400&h=400&fit=crop&v=3', 1, 'counter', 0),
  (2, 'Trà sữa trân châu', 45000, 'https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=400&h=400&fit=crop&v=3', 1, 'counter', 0),
  (2, 'Trà đào cam sả', 40000, 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=400&h=400&fit=crop&v=3', 1, 'counter', 0),
  (3, 'Nước ép cam', 35000, 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=400&h=400&fit=crop&v=3', 1, 'counter', 0),
  (3, 'Sinh tố bơ', 45000, 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=400&h=400&fit=crop&v=3', 0, 'counter', 0),
  (4, 'Bánh croissant', 25000, 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400&h=400&fit=crop&v=3', 1, 'counter', 0),
